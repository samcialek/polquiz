# Harness Run — Christian-Right Traditionalist
...
- Composed archetype label: **Communitarian Traditionalist**
- Identity-primary overlay: Evangelical Voter
- Engagement level: engaged

**Expected archetype family:** religious-right / Christian conservative
...
| top-1 archetype in acceptable list | `one of [082, 081, 083, 084, 106]` | `081 Heritage Guardian` | ✓ |
| vote match | `≥5/5` | `5/5` | ✓ |
| composed label contains "Traditionalist" | `Traditionalist` | `Communitarian Traditionalist` | ✓ |
...
| 2 | 103 | priority_sort | issue_salience_screener | `{"supportHigh":["cd","cu","mor","pro"],"supportMid":["mat","com","zs","ont_h"...` |
...
| 9 | 93 | priority_sort | priority_sort_opener | `{"supportHigh":["cd_high","cu_low","mor_low","pro_high","com_low"],"supportMi...` |
...
| 12 | 210 | single_choice | human_malleability_view | `"largely_fixed"` |
