const t = (node, kind, role, weight, touchType) => ({
    node,
    kind,
    role,
    weight,
...
const q = (id, stage, section, promptShort, uiType, quality, rewriteNeeded, touchProfile, exposeRules) => ({
    id,
    stage,
    section,
    promptShort,
...
export const FULL_QUESTIONS = [
    ...
    // SECTION I
    // ---------------------------------------------------------------------------
    q(1, "fixed12", "I", "political_content_frequency", "single_choice", 0.92, false, [
        t("ENG", "continuous", "position", 0.85, "behavior_frequency")
    ], { goodFollowupsIfUnresolved: [5, 9] }),
    q(2, "fixed12", "I", "political_identity_centrality", "slider", 0.94, false, [
    ...
    q(3, "fixed12", "I", "cultural_social_placement", "slider", 0.90, false, [
        t("CD", "continuous", "position", 0.90, "direct_placement")
    ], { goodFollowupsIfUnresolved: [4, 50, 52] }),
    q(4, "fixed12", "I", "cultural_social_salience", "slider", 0.93, false, [
    ...
    q(5, "screen20", "I", "engagement_motivations_top2", "multi", 0.86, false, [
    ...
    q(8, "screen20", "I", "domestic_vs_abroad_lives", "slider", 0.89, false, [
    ...
    q(9, "stage2", "I", "politics_at_social_gatherings", "single_choice", 0.86, false, [
    ...
    q(10, "stage3", "I", "climate_energy_bundle", "single_choice", 0.65, true, [
    ...
    q(11, "fixed12", "I", "nyt_headline_click", "single_choice", 0.86, false, [
    ...
    // SECTION II
    // ---------------------------------------------------------------------------
    q(12, "stage2", "II", "guess_top_marginal_tax_rate", "slider", 0.68, false, [
    ...
    q(13, "stage2", "II", "preferred_top_marginal_tax_rate", "slider", 0.88, false, [
        t("MAT", "continuous", "position", 0.92, "policy_preference")
    ], {
        eligibleIf: ["MAT_live_or_unresolved"],
        goodFollowupsIfUnresolved: [17, 27, 43]
    }),
    q(14, "stage2", "II", "university_admissions_approach", "single_choice", 0.83, false, [
    ...
    q(15, "fixed12", "II", "inequality_causes_allocation", "allocation", 0.91, false, [
    ...
    q(16, "stage3", "II", "criminal_justice_bundle", "single_choice", 0.65, true, [
    ...
    q(17, "stage2", "II", "ceo_worker_pay_ratio", "single_choice", 0.87, false, [
    ...
    q(18, "screen20", "II", "human_progress_view", "single_choice", 0.88, false, [
    ...
    q(19, "screen20", "II", "human_progress_salience", "slider", 0.93, false, [
        t("ONT_H", "continuous", "salience", 0.95, "direct_salience")
    ], {
        eligibleIf: ["ONT_H_live_or_unresolved"],
        goodFollowupsIfUnresolved: [18, 48, 49]
    }),
    q(20, "fixed12", "II", "bad_outcomes_blame_allocation", "allocation", 0.90, false, [
    ...
    q(21, "fixed12", "II", "controversial_speaker", "single_choice", 0.93, false, [
    ...
    q(22, "screen20", "II", "factual_estimates_and_confidence", "allocation", 0.95, false, [
    ...
    // SECTION III
    // ---------------------------------------------------------------------------
    q(23, "fixed12", "III", "who_should_shape_a_law", "ranking", 0.89, false, [
    ...
    q(24, "screen20", "III", "child_traits", "pairwise", 0.90, false, [
        t("ONT_H", "continuous", "position", 0.20, "human_nature_proxy")
    ], {
        eligibleIf: [],
        goodFollowupsIfUnresolved: [25, 59, 36]
    }),
    q(25, "screen20", "III", "criminal_trial_error_tradeoff", "single_choice", 0.92, false, [
    ...
    q(28, "stage2", "III", "mask_mandate_acceptability", "single_choice", 0.76, false, [], {
        eligibleIf: ["PRO_live_or_unresolved", "CU_live_or_unresolved"],
        goodFollowupsIfUnresolved: [41, 38]
    }),
    q(29, "stage2", "III", "factory_closure_causes_ranking", "ranking", 0.91, false, [
    ...
    q(30, "stage2", "III", "information_control_error_tradeoff", "single_choice", 0.90, false, [
    ...
    q(31, "fixed12", "III", "trade_liberalization_effects", "single_choice", 0.90, false, [
    ...
    q(34, "stage3", "III", "threats_to_america_external_internal", "single_choice", 0.65, true, [
    ...
    q(35, "stage2", "III", "percent_groups_want_best_share_values", "slider", 0.84, false, [
    ...
    // SECTION IV
    // ---------------------------------------------------------------------------
    q(36, "stage2", "IV", "fda_speed_vs_safety", "single_choice", 0.88, false, [
    ...
    q(37, "stage2", "IV", "stupid_workplace_rule_response", "single_choice", 0.80, false, [
    ...
    q(38, "screen20", "IV", "rules_procedures_matter_salience", "slider", 0.94, false, [
        t("PRO", "continuous", "salience", 0.95, "direct_salience")
    ], {
        eligibleIf: ["PRO_live_or_unresolved"],
        goodFollowupsIfUnresolved: [25, 30, 41]
    }),
    q(39, "screen20", "IV", "opponent_model_allocation", "allocation", 0.90, false, [
    ...
    q(40, "fixed12", "IV", "opponents_matter_to_identity", "slider", 0.91, false, [
    ...
    q(41, "stage2", "IV", "election_access_vs_security", "single_choice", 0.90, false, [
    ...
    q(42, "screen20", "IV", "close_friends_voted_differently", "single_choice", 0.88, false, [
    ...
    q(43, "stage2", "IV", "veil_of_ignorance_society_choice", "single_choice", 0.91, false, [
    ...
    q(44, "stage3", "IV", "views_changed_in_10_years", "slider", 0.58, false, [
    ...
    q(48, "screen20", "IV", "social_progress_view", "single_choice", 0.87, false, [
    ...
    q(49, "stage2", "IV", "social_progress_salience", "slider", 0.92, false, [
        t("ONT_H", "continuous", "salience", 0.95, "direct_salience"),
    ...
    q(50, "stage2", "IV", "integration_expectations_rewrite", "ranking", 0.72, false, [
    ...
    q(51, "screen20", "IV", "immigration_national_identity_salience", "slider", 0.93, false, [
    ...
    q(52, "stage2", "IV", "political_membership_criterion_rewrite", "single_choice", 0.74, false, [
    ...
    q(56, "screen20", "V", "effective_leader_style", "single_choice", 0.95, false, [
    ...
    q(61, "screen20", "V", "political_pitch_resonance", "single_choice", 0.94, false, [
    ...
    q(62, "screen20", "V", "movement_aesthetics_reaction", "single_choice", 0.90, false, [
    ...
    // SECTION VI
    // ---------------------------------------------------------------------------
    q(63, "screen20", "VI", "best_worst_battery", "best_worst", 0.95, false, [
    ...
    q(64, "stage2", "VI", "political_frustration", "single_choice", 0.93, false, [
    ...
    */ // end Q65-Q68 comment block
    ...
    q(69, "stage2", "VI", "common_ground_salience", "slider", 0.91, false, [
    ...
    */ // end Q70 comment block
    ...
    q(71, "stage2", "VI", "rhetoric_style_importance", "slider", 0.88, false, [
    ...
    */ // end Q73-Q75 comment block
    ...
    q(76, "stage2", "IV", "success_attribution", "single_choice", 0.91, false, [
    ...
    q(77, "stage2", "III", "decision_making_style", "single_choice", 0.93, false, [
    ...
    q(78, "stage2", "V", "speaker_appeal", "single_choice", 0.92, false, [
    ...
    q(79, "stage2", "III", "expert_disagreement_reaction", "single_choice", 0.90, false, [
        t("EPS", "categorical", "category", 0.82, "epistemic_response")
    ], {
        eligibleIf: ["EPS_live_or_unresolved"],
        goodFollowupsIfUnresolved: [77, 22, 44]
    }),
    q(80, "stage2", "I", "political_attention_style", "single_choice", 0.91, false, [
