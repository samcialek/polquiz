...
const election1976 = {
    ...
    candidates: [
        ...
        },
        {
            ...
            party: "Republican",
            year: 1976,
            MAT: 4, // Pro-market moderate Republican
            CD: 3, // Culturally moderate
            CU: 3, // Internationalist mainstream
            MOR: 3, // Moderate traditionalist
            PRO: 5, // Maximum proceduralist — healer, institutional legitimacy
            COM: 5, // Maximum compromise — "our long national nightmare is over"
            ZS: 2, // Positive-sum — healing, unity
            ONT_H: 3, // Moderate realism
            ONT_S: 2, // Individualist-leaning
            PF: 4, // Republican loyalist
            TRB: 2, // Broad appeal, low tribal signaling
            ENG: 4, // Institutional politician
    ...
    candidates: [
        {
            ...
            party: "Democratic",
            year: 2004,
            MAT: 2, // Mildly redistributive
            CD: 2, // Culturally open — Massachusetts liberal image
            CU: 4, // Pluralist/internationalist — multilateralist (CU high=open)
            MOR: 4, // Fairly universalist moral concern (MOR high=wide circle)
            PRO: 4, // Proceduralist but not max — rule of law, Senate (PRO high=rules-bound)
            COM: 4, // Compromiser — Senate dealmaker
            ZS: 2, // Positive-sum — multilateral cooperation
            ONT_H: 4, // Optimistic about human nature
            ONT_S: 2, // System mostly working — institutional defender (ONT_S low=stable)
            PF: 4, // Strong Democrat
            TRB: 3, // Moderate tribal — tried to broaden
            ENG: 4, // Engaged — but projected aloofness
    ...
    candidates: [
        {
            ...
            party: "Republican",
            year: 2024,
            MAT: 3, // Populist economics — tariffs, but also tax cuts
            CD: 5, // Maximum cultural closure — immigration, "poisoning the blood"
            CU: 1, // Maximum assimilationist/closed — America First extreme (CU low=closed)
            MOR: 2, // Narrow moral circle — in-group loyalty (MOR low=particularist)
            PRO: 1, // Maximum anti-proceduralist — "retribution," J6 pardons (PRO low=outcome-first)
            COM: 1, // Never compromise
            ZS: 5, // Maximum zero-sum — "they're destroying the country"
            ONT_H: 1, // Maximum pessimism — darkest rhetoric yet
            ONT_S: 4, // Deep structural critique — "system is rigged" (ONT_S high=system broken)
            PF: 4, // Party IS now MAGA — higher fusion than before
        ...
        },
        {
            ...
            party: "Democratic",
            year: 2024,
            MAT: 2, // Redistributive — "opportunity economy"
            CD: 2, // Culturally open — diversity, "we're not going back"
            CU: 4, // Pluralist/open — alliances, global engagement (CU high=open)
            MOR: 4, // Wide moral circle — reproductive rights, inclusion (MOR high=universalist)
            PRO: 4, // Proceduralist — prosecutor, "rule of law" (PRO high=rules-bound)
            ...
            ONT_S: 3, // Mixed systemic critique (ONT_S high=sees structural problems)
            PF: 4, // Strong Democrat
            TRB: 3, // Moderate tribal — broad coalition
            ENG: 5, // Maximum engagement
            EPS: 1, // Institutionalist — prosecutor, DA, AG (not empiricist)
            AES: 1, // Technocrat — policy-focused, not visionary (was too idealized)
        },
    ],
};
// ─────────────────────────────────────────────────────────────────────────────
