...
var PrismEngine = (() => {
  ...
  var REPRESENTATIVE_QUESTIONS = [
    ...
    },
    {
      ...
      touchProfile: [
        ...
        { node: "MORAL_CIRCLE", kind: "derived", role: "affinity", weight: 0.1, touchType: "moral_circle_affinity" }
      ],
      rankingMap: {
    ...
    },
    {
      ...
      touchProfile: [
        ...
        { node: "AES", kind: "categorical", role: "category", weight: 0.1, touchType: "decision_style_aes_secondary" }
      ],
      optionEvidence: {
        research_data: {
          categorical: {
    ...
    // Addresses: 050 Religious Leftist ↔ 049 Paternal Egalitarian; 070 ↔ 075; CD/CU seam
    {
      ...
      optionEvidence: {
        ...
        pluralist_with_common_ground: {
          continuous: {
            CD: { pos: [0.28, 0.38, 0.22, 0.09, 0.03] },
            // peak pos=2 (lean-open)
            CU: { pos: [0.08, 0.22, 0.36, 0.22, 0.12] },
            // peak pos=3 (mixed)
            MOR: { pos: [0.08, 0.16, 0.26, 0.32, 0.18] }
            // peak pos=4 (wide-leaning)
          }
    ...
    // Q-A1: universal_baseline_humanity
    {
      ...
      rewriteNeeded: false,
      touchProfile: [
        { node: "MORAL_CIRCLE", kind: "derived", role: "affinity", weight: 0.1, touchType: "universal_baseline" }
      ],
    ...
    // when universal is moderate; only "much_more" creates excess for high-universal users.
    {
      ...
      rewriteNeeded: false,
      touchProfile: [
        { node: "MORAL_CIRCLE", kind: "derived", role: "affinity", weight: 0.1, touchType: "scoped_affinity_probe" }
      ],
      optionEvidence: {
    ...
    // anchors; the promptFull conveys the scenario.
    {
      ...
      promptFull: "A policy you support is only passable as part of a package deal that also funds or authorizes something you strongly oppose. The opposed provision passes either way \u2014 only the supported policy depends on your backing. How often do you accept that deal? (0 = almost never; 100 = almost always)",
      uiType: "slider",
      quality: 0.91,
      rewriteNeeded: false,
      touchProfile: [
        { node: "COM", kind: "continuous", role: "position", weight: 0.9, touchType: "legislative_compromise_threshold" }
      ],
      sliderMap: {
        "0-20": { continuous: { COM: { pos: [0.55, 0.3, 0.12, 0.02, 0.01] } } },
        "21-40": { continuous: { COM: { pos: [0.25, 0.4, 0.25, 0.08, 0.02] } } },
        "41-60": { continuous: { COM: { pos: [0.08, 0.22, 0.4, 0.22, 0.08] } } },
        "61-80": { continuous: { COM: { pos: [0.02, 0.08, 0.25, 0.4, 0.25] } } },
        "81-100": { continuous: { COM: { pos: [0.01, 0.02, 0.12, 0.3, 0.55] } } }
      }
    },
    ...
    // selector deprioritizes single-touch questions otherwise).
    {
      ...
      promptFull: "You picked religion as something that matters for membership. Which best describes how religion fits into public life for you?",
      uiType: "single_choice",
      priorityBattery: true,
      quality: 0.92,
      rewriteNeeded: false,
      ...
      touchProfile: [
        { node: "MORAL_CIRCLE", kind: "derived", role: "affinity", weight: 0.3, touchType: "religion_political_role" }
      ],
      optionEvidence: {
  ...
  function evaluatePredicate(state, predicate) {
    ...
    switch (predicate) {
      ...
      case "q102_religion_supported": {
        ...
        if (!q102Ans) return false;
        return (q102Ans.supportHigh?.includes("religion") ?? false) || (q102Ans.supportMid?.includes("religion") ?? false);
      }
      default:
        return false;
    }
  ...
  var non_ideological_data_default = {
    _meta: {
      ...
      charisma_methodology: "Polling-derived since 2026-05-14. 1948+: 15-day pre-election averages (Gallup approval for incumbents, net favorability for non-incumbents). Pre-1948: neutral (charisma=3.0). See results/non-ideological/polling-derived-charisma.md for methodology and source-confidence ratings."
    },
    elections: {
      "1789": {
        incumbent_party: null,
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "First election; no incumbent party. Post-Revolution recovery, debt restructuring beginning."
      },
      "1792": {
        incumbent_party: "Federalist",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Early expansion under Hamilton's financial system."
      },
      "1796": {
        incumbent_party: "Federalist",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Solid growth, no panic. Whiskey Rebellion resolved."
      },
      "1800": {
        incumbent_party: "Federalist",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Moderate growth."
      },
      "1804": {
        incumbent_party: "Democratic-Republican",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Louisiana Purchase era expansion."
      },
      "1808": {
        incumbent_party: "Democratic-Republican",
        raw_econ: -0.2,
        tier: "binary_pre_1929",
        tier_category: "nber_recession",
        notes: "Embargo Act (1807) caused severe contraction, especially New England. Deep recession but not on user's canonical major-panic list."
      },
      "1812": {
        incumbent_party: "Democratic-Republican",
        raw_econ: -0.2,
        tier: "binary_pre_1929",
        tier_category: "nber_recession",
        notes: "Embargo aftermath plus war just begun. Uncertainty-driven recession."
      },
      "1816": {
        incumbent_party: "Democratic-Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Post-War of 1812 recovery; Era of Good Feelings beginning."
      },
      "1820": {
        incumbent_party: "Democratic-Republican",
        raw_econ: -0.4,
        tier: "binary_pre_1929",
        tier_category: "major_panic",
        notes: "Panic of 1819 ongoing. User-listed major panic."
      },
      "1824": {
        incumbent_party: "Democratic-Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Recovery from Panic of 1819. One-party era (all candidates D-R factions)."
      },
      "1828": {
        incumbent_party: "National Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Moderate expansion. JQ Adams incumbent (Nat-Rep faction)."
      },
      "1832": {
        ...
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Jackson's early era, expansion."
      },
      "1836": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Land speculation bubble (pre-Panic of 1837). Economy looked strong on election day."
      },
      "1840": {
        incumbent_party: "Democratic",
        raw_econ: -0.4,
        tier: "binary_pre_1929",
        tier_category: "major_panic",
        notes: "Panic of 1837 / 1839-43 depression ongoing. User-listed major panic."
      },
      "1844": {
        incumbent_party: null,
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Recovery from 1837-43 depression. Tyler was expelled by the Whigs in 1841 and governed as a man without a party for three years. Setting incumbent_party: null so the modifier goes silent for 1844 rather than crediting/debiting Clay (Whig) or Polk (D) for Tyler's record. Both get economic_component = 0."
      },
      "1848": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "California Gold Rush beginning; Mexican War ended."
      },
      "1852": {
        incumbent_party: "Whig",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Mild expansion."
      },
      "1856": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Pre-Panic of 1857 boom (railroads, Gold Rush wealth still circulating)."
      },
      "1860": {
        incumbent_party: "Democratic",
        raw_econ: -0.2,
        tier: "binary_pre_1929",
        tier_category: "nber_recession",
        notes: "Panic of 1857 aftermath plus secession crisis. Mild recession at election time."
      },
      "1864": {
        ...
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Union war economy booming. Attribution: R/Lincoln administration."
      },
      "1868": {
        incumbent_party: "Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Post-war Reconstruction. Andrew Johnson was a War Democrat but on Lincoln's ticket; attribution = R per user rule."
      },
      "1872": {
        incumbent_party: "Republican",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Pre-Panic of 1873 expansion."
      },
      "1876": {
        incumbent_party: "Republican",
        raw_econ: -0.4,
        tier: "binary_pre_1929",
        tier_category: "major_panic",
        notes: "Panic of 1873 / Long Depression 1873-79. User-listed major panic."
      },
      "1880": {
        incumbent_party: "Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Recovery from Long Depression."
      },
      "1884": {
        incumbent_party: "Republican",
        raw_econ: -0.2,
        tier: "binary_pre_1929",
        tier_category: "nber_recession",
        notes: "1882-85 NBER contraction still active at election time."
      },
      "1888": {
        incumbent_party: "Democratic",
        raw_econ: 0,
      ...
      "1892": {
        ...
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Expansion, but 1893 panic looming (not yet at election)."
      },
      "1896": {
        incumbent_party: "Democratic",
        raw_econ: -0.4,
        tier: "binary_pre_1929",
        tier_category: "major_panic",
        notes: "Panic of 1893 aftermath, depression bottom. User-listed major panic."
      },
      "1900": {
        incumbent_party: "Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "Expansion ending; Dec 1900 trough just ahead. Call it neutral at Nov election."
      },
      "1904": {
        incumbent_party: "Republican",
        raw_econ: -0.2,
        tier: "binary_pre_1929",
        tier_category: "nber_recession",
        notes: "1902-04 NBER contraction ended Aug 1904 \u2014 still fresh in voter memory at Nov election."
      },
      "1908": {
        incumbent_party: "Republican",
        raw_econ: -0.4,
        tier: "binary_pre_1929",
        tier_category: "major_panic",
        notes: "Panic of 1907 aftermath. User-listed major panic."
      },
      "1912": {
        incumbent_party: "Republican",
        raw_econ: -0.2,
        tier: "binary_pre_1929",
        tier_category: "nber_recession",
        notes: "1910-12 contraction just ended."
      },
      "1916": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "WWI wartime economy booming (US not yet belligerent)."
      },
      "1920": {
        incumbent_party: "Democratic",
        raw_econ: -0.4,
        tier: "binary_pre_1929",
        tier_category: "major_panic",
        notes: "Depression of 1920-21 active. User-listed major panic."
      },
      "1924": {
        incumbent_party: "Republican",
        raw_econ: 0,
        tier: "binary_pre_1929",
        tier_category: "normal",
        notes: "1923-24 mild contraction ended July 1924. Election in expansion."
      },
      "1928": {
        incumbent_party: "Republican",
        raw_econ: 0.2,
        tier: "binary_pre_1929",
        tier_category: "boom",
        notes: "Roaring Twenties peak."
      },
      "1932": {
        incumbent_party: "Republican",
        raw_econ: -1,
        tier: "annual_1929_1947",
        gdp_growth_pct: -13,
        unemp_delta_pct: 7.7,
        notes: "Great Depression trough. Unemployment 23.6% (prev year 15.9%). Both terms saturate low."
      },
      "1936": {
        incumbent_party: "Democratic",
        raw_econ: 1,
        ...
        gdp_growth_pct: 12.9,
        unemp_delta_pct: -3.2,
        notes: "Roaring recovery. Unemployment 16.9% (prev 20.1%). Both terms saturate high."
      },
      "1940": {
        incumbent_party: "Democratic",
        raw_econ: 1,
        ...
        gdp_growth_pct: 8.8,
        unemp_delta_pct: -2.6,
        notes: "1938 recession passed; pre-war buildup boosting GDP. Unemployment 14.6% (prev 17.2%)."
      },
      "1944": {
        incumbent_party: "Democratic",
        raw_econ: 0.8,
        ...
        gdp_growth_pct: 8.3,
        unemp_delta_pct: -0.7,
        notes: "War economy. Unemployment 1.2% (prev 1.9%). GDP term saturates high."
      },
      "1948": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 4.1,
        inflation_yoy_pct: 3.5,
        unemp_delta_pct: -0.2,
        notes: "Truman. Inflation falling from 1947 peak (14%). Post-war conversion mostly complete."
      },
      "1952": {
        incumbent_party: "Democratic",
        raw_econ: 0.5,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 4.1,
        inflation_yoy_pct: 0.8,
        unemp_delta_pct: -0.4,
        notes: "Korean War economy. Low inflation (price controls), tight labor market. Signal boosts D (the incumbent party), but voters picked Ike anyway \u2014 20-year fatigue trumps economic signal."
      },
      "1956": {
        incumbent_party: "Republican",
        raw_econ: 0,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 0.1,
        inflation_yoy_pct: 1.9,
        unemp_delta_pct: 0.1,
        notes: "Eisenhower. Q2 1956 GDP growth was a slow 0.1% SAAR (Q4 recovered to +4.6%); Q2-anchored formula underweights the full year (~2.1%). Documented caveat in _meta."
      },
      "1960": {
        incumbent_party: "Republican",
        raw_econ: -0.1,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 2.6,
        inflation_yoy_pct: 1.4,
        unemp_delta_pct: 1.1,
        notes: "Eisenhower's 1960 recession. Unemployment rising from 5.0% to 6.1%. Kennedy narrow win."
      },
      "1964": {
        incumbent_party: "Democratic",
        raw_econ: 0.6,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 5.8,
        inflation_yoy_pct: 1.2,
        unemp_delta_pct: -0.3,
        notes: "LBJ post-Kennedy tax cuts; strong growth, low inflation."
      },
      "1968": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 4.8,
        inflation_yoy_pct: 4.4,
        unemp_delta_pct: -0.3,
        notes: "Vietnam/Great Society era. Growth still strong, inflation beginning to bite."
      },
      "1972": {
        incumbent_party: "Republican",
        raw_econ: 0.4,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 5.3,
        inflation_yoy_pct: 3.4,
        unemp_delta_pct: -0.3,
        notes: "Nixon price-controls era. Growth strong, inflation hidden for now."
      },
      "1976": {
        incumbent_party: "Republican",
        raw_econ: 0.2,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 5.4,
        inflation_yoy_pct: 5.5,
        unemp_delta_pct: -0.7,
        notes: "Strong recovery from 1974-75 recession, but inflation still 5.5% and unemployment 7.7% \u2014 formula mildly positive; doesn't capture stagflation fatigue."
      },
      "1980": {
        incumbent_party: "Democratic",
        raw_econ: -1,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: -0.3,
        inflation_yoy_pct: 12.6,
        unemp_delta_pct: 1.5,
        notes: "Stagflation nadir. All three terms saturate low. Carter obliterated."
      },
      "1984": {
        incumbent_party: "Republican",
        raw_econ: 0.5,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 7.2,
        inflation_yoy_pct: 4,
        unemp_delta_pct: -1.2,
        notes: "Morning in America. GDP term saturates high, unemployment dropping fast."
      },
      "1988": {
        incumbent_party: "Republican",
        raw_econ: 0.2,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 4.2,
        inflation_yoy_pct: 4.2,
        unemp_delta_pct: -0.5,
        notes: "Late Reagan expansion; moderate growth."
      },
      "1992": {
        incumbent_party: "Republican",
        raw_econ: 0,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 3.5,
        inflation_yoy_pct: 3.2,
        unemp_delta_pct: 0.4,
        notes: "Recovery from 1990-91 recession; jobless-recovery sentiment (unemployment STILL rising through 1992). Formula near zero; 'it's the economy, stupid' not captured."
      },
      "1996": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 3.8,
        inflation_yoy_pct: 3,
        unemp_delta_pct: -0.2,
        notes: "Clinton/Gingrich expansion."
      },
      "2000": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        ...
        inflation_yoy_pct: 3.4,
        unemp_delta_pct: -0.1,
        notes: "End of dot-com boom. Very tight labor market."
      },
      "2004": {
        incumbent_party: "Republican",
        raw_econ: 0.2,
        ...
        inflation_yoy_pct: 3.2,
        unemp_delta_pct: -0.4,
        notes: "Bush re-election; moderate post-2001-recession recovery."
      },
      "2008": {
        incumbent_party: "Republican",
        raw_econ: -0.8,
        ...
        unemp_delta_pct: 1.9,
        notes: "Financial crisis. GDP and unemployment terms both saturate low."
      },
      "2012": {
        incumbent_party: "Democratic",
        raw_econ: 0.2,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 2.3,
        inflation_yoy_pct: 2.2,
        unemp_delta_pct: -1,
        notes: "Obama re-election. Slow recovery but unemployment falling."
      },
      "2016": {
        incumbent_party: "Democratic",
        raw_econ: 0,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: 1.7,
        inflation_yoy_pct: 1.6,
        unemp_delta_pct: -0.2,
        notes: "Slow growth. Formula near zero. Trump's victory driven by non-economic sorting."
      },
      "2020": {
        incumbent_party: "Republican",
        raw_econ: -0.5,
        tier: "quarterly_1948_plus",
        gdp_q2_annualized: -3.4,
        inflation_yoy_pct: 1.2,
        unemp_delta_pct: 3,
    ...
    candidates: {
      Washington_1789: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Washington_1789",
        party: "Unaffiliated",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Washington_1792: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "Washington_1792",
        party: "Unaffiliated",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Adams_1796: {
      ...
      Clinton_1812: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Clinton_1812",
        party: "Federalist",
        note: "DeWitt Clinton, not Bill Clinton",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Monroe_1816: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Monroe_1816",
        party: "Democratic-Republican",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      King_1816: {
      ...
      Adams_1824: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Adams_1824",
        party: "Democratic-Republican",
        note: "John Quincy Adams",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Jackson_1824: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Jackson_1824",
        party: "Democratic-Republican",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Crawford_1824: {
      ...
      Harrison_1836: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Harrison_1836",
        party: "Whig",
        note: "William Henry Harrison",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Harrison_1840: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Harrison_1840",
        party: "Whig",
        note: "William Henry Harrison",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      ...
      Breckinridge_1860: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Breckinridge_1860",
      ...
      Cleveland_1892: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Cleveland_1892",
        party: "Democratic",
        note: "Non-consecutive comeback; NOT flagged incumbent per rule",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Harrison_1892: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "Harrison_1892",
        party: "Republican",
        note: "Benjamin Harrison",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      ...
      Roosevelt_1904: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "RooseveltTheodore_1904",
        party: "Republican",
        note: "Theodore Roosevelt (succeeded from McKinley assassination 1901)",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Parker_1904: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Parker_1904",
        party: "Democratic",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Taft_1908: {
      ...
      Roosevelt_1912: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Roosevelt_1912",
        party: "Progressive/Bull Moose",
        note: "Theodore Roosevelt running as third-party",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Wilson_1916: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "Wilson_1916",
        party: "Democratic",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Hughes_1916: {
      ...
      Coolidge_1924: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "Coolidge_1924",
        party: "Republican",
        note: "Succeeded from Harding death 1923",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Davis_1924: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Davis_1924",
        party: "Democratic",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      LaFollette_1924: {
      ...
      Roosevelt_1932: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "RooseveltFranklin_1932",
        party: "Democratic",
        note: "FDR",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      ...
      Roosevelt_1936: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "RooseveltFranklin_1936",
        party: "Democratic",
        note: "FDR",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      ...
      Roosevelt_1940: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "RooseveltFranklin_1940",
        party: "Democratic",
        note: "FDR (third term)",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      ...
      Roosevelt_1944: {
        is_incumbent_person: true,
        charisma: 3,
        consensus_key: "RooseveltFranklin_1944",
        party: "Democratic",
        note: "FDR (fourth term)",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Dewey_1944: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Dewey_1944",
        party: "Republican",
        charisma_source: "neutral (pre-polling era; no signal claimed)"
      },
      Truman_1948: {
        is_incumbent_person: true,
        charisma: 2,
        consensus_key: "Truman_1948",
        party: "Democratic",
        note: "Succeeded from FDR death 1945",
        charisma_source: "Gallup approval ~40% (15-day late-Oct avg, post-Whistlestop tightening)"
      },
      Dewey_1948: {
        is_incumbent_person: false,
        charisma: 3.5,
        consensus_key: "Dewey_1948",
        party: "Republican",
        charisma_source: "Net favorability ~+8 (pre-1950 polling sparse; estimate)"
      },
      Thurmond_1948: {
        is_incumbent_person: false,
        charisma: 1.3,
        consensus_key: "Thurmond_1948",
        party: "Dixiecrat/States' Rights",
        charisma_source: "Net favorability ~-25 (Dixiecrat segregationist run, low national favorability)"
      },
      HWallace_1948: {
        is_incumbent_person: false,
        charisma: 2,
        consensus_key: "WallaceHenry_1948",
        party: "Progressive",
        note: "Henry A. Wallace",
        charisma_source: "Net favorability ~-15 (Progressive Party, Soviet-sympathy framing hurt him)"
      },
      Eisenhower_1952: {
        is_incumbent_person: false,
        charisma: 5,
        consensus_key: "Eisenhower_1952",
        party: "Republican",
        charisma_source: "Net favorability ~+35 (war hero, broadly liked across parties)"
      },
      Stevenson_1952: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Stevenson_1952",
        party: "Democratic",
        charisma_source: "Net favorability ~+5 (intellectual, perceived stiff)"
      },
      Eisenhower_1956: {
        is_incumbent_person: true,
        charisma: 4.7,
        consensus_key: "Eisenhower_1956",
        party: "Republican",
        charisma_source: "Gallup approval ~67% (15-day Oct avg, strong second-term position)"
      },
      Stevenson_1956: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Stevenson_1956",
        party: "Democratic",
        charisma_source: "Net favorability ~0 (rematch fatigue)"
      },
      Kennedy_1960: {
        is_incumbent_person: false,
        charisma: 4,
        consensus_key: "Kennedy_1960",
        party: "Democratic",
        charisma_source: "Net favorability ~+15 (charismatic, telegenic, post-debates bump)"
      },
      Nixon_1960: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Nixon_1960",
        party: "Republican",
        charisma_source: "Net favorability ~+5 (sitting VP, hurt by sweat-debate optics)"
      },
      Johnson_1964: {
        is_incumbent_person: true,
        charisma: 5,
        consensus_key: "Johnson_1964",
        party: "Democratic",
        note: "LBJ, succeeded from JFK assassination 1963",
        charisma_source: "Gallup approval ~74% (post-Kennedy assassination, pre-Vietnam escalation)"
      },
      Goldwater_1964: {
        is_incumbent_person: false,
        charisma: 2,
        consensus_key: "Goldwater_1964",
        party: "Republican",
        charisma_source: "Net favorability ~-15 ('extremism in defense of liberty' damaged image)"
      },
      Nixon_1968: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Nixon_1968",
        party: "Republican",
        charisma_source: "Net favorability ~+5 ('New Nixon' comeback narrative)"
      },
      Humphrey_1968: {
        is_incumbent_person: false,
        charisma: 3,
        consensus_key: "Humphrey_1968",
        party: "Democratic",
        charisma_source: "Net favorability ~0 (tied to LBJ/Vietnam unpopularity)"
      },
      Wallace_1968: {
        is_incumbent_person: false,
        charisma: 2.3,
        consensus_key: "WallaceGeorge_1968",
        party: "American Independent",
        note: "George Wallace",
        charisma_source: "Net favorability ~-10 (segregationist third-party run)"
      },
      Nixon_1972: {
        is_incumbent_person: true,
        charisma: 3.8,
        consensus_key: "Nixon_1972",
        party: "Republican",
        charisma_source: "Gallup approval ~58% (pre-Watergate revelations, post-China opening)"
      },
      McGovern_1972: {
        is_incumbent_person: false,
        charisma: 1.7,
        consensus_key: "McGovern_1972",
        party: "Democratic",
        charisma_source: "Net favorability ~-20 (Eagleton VP debacle; never recovered)"
      },
      Carter_1976: {
        is_incumbent_person: false,
        charisma: 4,
        consensus_key: "Carter_1976",
        party: "Democratic",
        charisma_source: "Net favorability ~+15 (fresh-face outsider post-Watergate)"
      },
      Ford_1976: {
        is_incumbent_person: true,
        charisma: 2.5,
        consensus_key: "Ford_1976",
        party: "Republican",
        note: "Succeeded from Nixon resignation 1974",
        charisma_source: "Gallup approval ~45% (appointed incumbent, Nixon-pardon backlash)"
      },
      Reagan_1980: {
        is_incumbent_person: false,
        charisma: 4,
        consensus_key: "Reagan_1980",
        party: "Republican",
        charisma_source: "Net favorability ~+15 (strong communicator, Carter-fatigue tailwind)"
      },
      Carter_1980: {
        is_incumbent_person: true,
        charisma: 1.5,
        consensus_key: "Carter_1980",
        party: "Democratic",
        charisma_source: "Gallup approval ~35% (15-day Oct avg; late hostage-crisis news further weakened)"
      },
      Anderson_1980: {
        is_incumbent_person: false,
        charisma: 2.7,
        consensus_key: "Anderson_1980",
        party: "Independent",
        charisma_source: "Net favorability ~-5 (independent third-party, diminished by November)"
      },
      Reagan_1984: {
        is_incumbent_person: true,
        charisma: 3.8,
        consensus_key: "Reagan_1984",
        party: "Republican",
        charisma_source: "Gallup approval ~58% (15-day Oct avg; 'Morning in America' incumbent strength)"
      },
      Mondale_1984: {
        is_incumbent_person: false,
        charisma: 2.7,
        consensus_key: "Mondale_1984",
        party: "Democratic",
        charisma_source: "Net favorability ~-5 (overshadowed by Reagan)"
      },
      Bush_1988: {
        is_incumbent_person: false,
        charisma: 4.3,
        consensus_key: "BushGeorgeHW_1988",
        party: "Republican",
        note: "George H.W. Bush",
        charisma_source: "Net favorability ~+20 (Reagan's VP, riding tailwind)"
      },
      Dukakis_1988: {
        is_incumbent_person: false,
        charisma: 2.3,
        consensus_key: "Dukakis_1988",
        party: "Democratic",
        charisma_source: "Net favorability ~-10 (15-day post-tank-ad / post-Willie-Horton collapse)"
      },
      Clinton_1992: {
        is_incumbent_person: false,
        charisma: 4,
        consensus_key: "ClintonBill_1992",
        party: "Democratic",
        note: "Bill Clinton",
        charisma_source: "Net favorability ~+15 ('I feel your pain' boomer charisma)"
      },
      Bush_1992: {
        is_incumbent_person: true,
        charisma: 1.4,
        consensus_key: "BushGeorgeHW_1992",
        party: "Republican",
        note: "George H.W. Bush",
        charisma_source: "Gallup approval ~34% (post-Gulf-War highs collapsed by recession)"
      },
      Perot_1992: {
        is_incumbent_person: false,
        charisma: 4,
        consensus_key: "Perot_1992",
        party: "Independent",
        charisma_source: "Net favorability ~+15 (late-Oct figure, after dropout-and-rejoin; summer peak ~+25)"
      },
      Clinton_1996: {
        is_incumbent_person: true,
        charisma: 3.7,
        consensus_key: "ClintonBill_1996",
        party: "Democratic",
        note: "Bill Clinton",
        charisma_source: "Gallup approval ~57% (strong economy, mid-term recovery)"
      },
      Dole_1996: {
        is_incumbent_person: false,
        charisma: 2.7,
        consensus_key: "Dole_1996",
        party: "Republican",
        charisma_source: "Net favorability ~-5 (stale-image generational mismatch)"
      },
      Perot_1996: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Perot_1996",
        party: "Reform",
        charisma_source: "Net favorability ~+5 (diminished from 1992)"
      },
      Gore_2000: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Gore_2000",
        party: "Democratic",
        charisma_source: "Net favorability ~+5 (sigh-debate, perceived stiff)"
      },
      Bush_2000: {
        is_incumbent_person: false,
        charisma: 3.7,
        consensus_key: "BushGeorgeW_2000",
        party: "Republican",
        note: "George W. Bush",
        charisma_source: "Net favorability ~+10 (compassionate-conservative branding)"
      },
      Nader_2000: {
        is_incumbent_person: false,
        charisma: 2.3,
        consensus_key: "Nader_2000",
        party: "Green",
        charisma_source: "Net favorability ~-10 (Green Party third-party)"
      },
      Kerry_2004: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Kerry_2004",
        party: "Democratic",
        charisma_source: "Net favorability ~+5 (swift-boating brought favorability down)"
      },
      Bush_2004: {
        is_incumbent_person: true,
        charisma: 2.8,
        consensus_key: "BushGeorgeW_2004",
        party: "Republican",
        note: "George W. Bush",
        charisma_source: "Gallup approval ~48% (15-day Oct avg; 9/11 lift faded, Iraq War polarizing)"
      },
      Obama_2008: {
        is_incumbent_person: false,
        charisma: 4.7,
        consensus_key: "Obama_2008",
        party: "Democratic",
        charisma_source: "Net favorability ~+25 (generational-change wave, post-financial-crisis boost)"
      },
      McCain_2008: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "McCain_2008",
        party: "Republican",
        charisma_source: "Net favorability ~+5 (war-hero respect dragged by Palin pick + economic-crisis response)"
      },
      Obama_2012: {
        is_incumbent_person: true,
        charisma: 3.2,
        consensus_key: "Obama_2012",
        party: "Democratic",
        charisma_source: "Gallup approval ~52% (15-day Oct avg; modest positive, post-2010-midterm recovery)"
      },
      Romney_2012: {
        is_incumbent_person: false,
        charisma: 2.7,
        consensus_key: "Romney_2012",
        party: "Republican",
        charisma_source: "Net favorability ~-5 ('47%' tape, Bain Capital framing)"
      },
      Trump_2016: {
        is_incumbent_person: false,
        charisma: 1.3,
        consensus_key: "Trump_2016",
        party: "Republican",
        charisma_source: "Net favorability ~-25 (lowest-favorability major-party nominee in polling era)"
      },
      Clinton_2016: {
        is_incumbent_person: false,
        charisma: 2,
        consensus_key: "ClintonHillary_2016",
        party: "Democratic",
        note: "Hillary Clinton",
        charisma_source: "Net favorability ~-15 (email-server saga, second-lowest favorability)"
      },
      Johnson_2016: {
        is_incumbent_person: false,
        charisma: 2.3,
        consensus_key: "JohnsonGary_2016",
        party: "Libertarian",
        note: "Gary Johnson",
        charisma_source: "Net favorability ~-10 (Libertarian third-party, 'What is Aleppo?')"
      },
      Biden_2020: {
        is_incumbent_person: false,
        charisma: 3.3,
        consensus_key: "Biden_2020",
        party: "Democratic",
        charisma_source: "Net favorability ~+5 (net-positive, generic-D favorability)"
      },
      Trump_2020: {
        is_incumbent_person: true,
        charisma: 2.6,
        consensus_key: "Trump_2020",
        party: "Republican",
        charisma_source: "Gallup approval ~46% (15-day Oct avg; COVID-era drag from earlier highs)"
      },
      Trump_2024: {
        is_incumbent_person: false,
        charisma: 2,
        consensus_key: "Trump_2024",
        party: "Republican",
        note: "Non-consecutive comeback; NOT flagged incumbent per rule",
        charisma_source: "Net favorability ~-15 (improved from 2016/2020 but still net-negative)"
      },
      Harris_2024: {
        is_incumbent_person: false,
        charisma: 2.7,
        consensus_key: "Harris_2024",
        party: "Democratic",
        note: "Replaced Biden mid-campaign; not the sitting president",
        charisma_source: "Net favorability ~-5 (mid-campaign Biden replacement; mixed favorability)"
      }
    }
  };
  ...
  // src/browser/api.ts
  var BUNDLE_VERSION = "20260514-polling-derived-charisma";
  var _state = null;
  var _questions = [];
