import { AES_PROTOTYPES, EPS_PROTOTYPES } from "./categories.js";
export const REPRESENTATIVE_QUESTIONS = [
    ...
    */ // end Q76 comment block
    ...
    // political aesthetics directly and uses most/least appealing picks.
    {
        ...
        promptFull: "Pick the political leadership style you find most appealing and the " +
    ...
    // questions on ruled-out nodes. Forced to position 1 in FIXED_OPENER.
    {
        ...
        promptFull: "Sort each political topic by how much it enters into your politics. " +
    ...
    // (institutional trust) and TRB (national identification).
    {
        ...
        optionEvidence: {
            ...
            proud_distrustful: {
                continuous: {
                    ONT_S: { pos: [0.13, 0.23, 0.33, 0.21, 0.10] },
                    TRB: { pos: [0.05, 0.15, 0.30, 0.30, 0.20] }
                }
            },
    ...
    // universalism for MOR).
    {
        ...
        promptFull: "Setting aside how well institutions function right now, how essential " +
    ...
    // is the open dimension.
    {
        ...
        promptFull: "Looking at major political progress in the United States over the " +
    ...
    //   shrink_government     → libertarian / small-government conservative
    {
        ...
        promptFull: "If you were prioritizing one approach to strengthen American democracy " +
    ...
    // anchors; the promptFull conveys the scenario.
    {
        ...
        promptFull: "A policy you support is only passable as part of a package deal " +
