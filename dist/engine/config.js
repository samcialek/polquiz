...
export const UNIVERSAL_SCREENERS = [
...
export const MEANINGFUL_POSITION_WEIGHT = 0.4;
...
export const POSITION_DRILL_SAL_FLOOR = 1.5;
...
export const MIN_POSITION_TOUCHES_PER_TOP_K = 2;
export const MAX_POSITION_TOUCHES_TOP_K = 4;
export const MAX_POSITION_TOUCHES_NON_TOP_K = 3;
