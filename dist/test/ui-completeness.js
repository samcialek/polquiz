...
if (issues.length === 0) {
    ...
    // Group by severity
    const critical = issues.filter(i => i.problem.includes("no options") ||
        i.problem.includes("no items") ||
        i.problem.includes("no buckets") ||
        i.problem.includes("no pairs"));
    const cosmetic = issues.filter(i => i.problem.includes("optionLabels") ||
...
//# sourceMappingURL=ui-completeness.js.map