...
export const REPRESENTATIVE_QUESTIONS: QuestionDef[] = [
  ...
  */ // end Q76 comment block
  ...
  //   conditions align.)
  {
    ...
    promptFull:
      "How much extra moral concern do you feel for each of these groups, beyond what you feel for people in general? Sort each into the column that fits best.",
    uiType: "priority_sort",
    quality: 0.97,
    rewriteNeeded: false,
    optionLabels: {
  ...
  // selector deprioritizes single-touch questions otherwise).
  {
    ...
    promptFull:
      "You picked religion as something that matters for membership. " +
