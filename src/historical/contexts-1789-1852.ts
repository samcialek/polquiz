...
// ─────────────────────────────────────────────────────────────────────────────
const context1789: ElectionContext = {
  year: 1789,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1792: ElectionContext = {
  year: 1792,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1796: ElectionContext = {
  year: 1796,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1800: ElectionContext = {
  year: 1800,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1804: ElectionContext = {
  year: 1804,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1808: ElectionContext = {
  year: 1808,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1812: ElectionContext = {
  year: 1812,
  zeitgeist: {
    era: "founding",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1816: ElectionContext = {
  year: 1816,
  zeitgeist: {
    era: "good-feelings",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1820: ElectionContext = {
  year: 1820,
  zeitgeist: {
    era: "good-feelings",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1824: ElectionContext = {
  year: 1824,
  zeitgeist: {
    era: "good-feelings",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1828: ElectionContext = {
  year: 1828,
  zeitgeist: {
    era: "jacksonian",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1832: ElectionContext = {
  year: 1832,
  zeitgeist: {
    era: "jacksonian",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1836: ElectionContext = {
  year: 1836,
  zeitgeist: {
    era: "jacksonian",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1840: ElectionContext = {
  year: 1840,
  zeitgeist: {
    era: "jacksonian",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1844: ElectionContext = {
  year: 1844,
  zeitgeist: {
    era: "jacksonian",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1848: ElectionContext = {
  year: 1848,
  zeitgeist: {
    era: "jacksonian",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1852: ElectionContext = {
  year: 1852,
  zeitgeist: {
    era: "jacksonian",
...
// Export
// ─────────────────────────────────────────────────────────────────────────────
export const CONTEXTS_1789_1852: ElectionContext[] = [
