...
// ─────────────────────────────────────────────────────────────────────────────
const context1920: ElectionContext = {
  year: 1920,
  zeitgeist: {
    era: "normalcy",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1924: ElectionContext = {
  year: 1924,
  zeitgeist: {
    era: "normalcy",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1928: ElectionContext = {
  year: 1928,
  zeitgeist: {
    era: "normalcy",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1932: ElectionContext = {
  year: 1932,
  zeitgeist: {
    era: "new-deal",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1936: ElectionContext = {
  year: 1936,
  zeitgeist: {
    era: "new-deal",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1940: ElectionContext = {
  year: 1940,
  zeitgeist: {
    era: "new-deal",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1944: ElectionContext = {
  year: 1944,
  zeitgeist: {
    era: "new-deal",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1948: ElectionContext = {
  year: 1948,
  zeitgeist: {
    era: "new-deal",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1952: ElectionContext = {
  year: 1952,
  zeitgeist: {
    era: "consensus",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1956: ElectionContext = {
  year: 1956,
  zeitgeist: {
    era: "consensus",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1960: ElectionContext = {
  year: 1960,
  zeitgeist: {
    era: "consensus",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1964: ElectionContext = {
  year: 1964,
  zeitgeist: {
    era: "upheaval",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1968: ElectionContext = {
  year: 1968,
  zeitgeist: {
    era: "upheaval",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1972: ElectionContext = {
  year: 1972,
  zeitgeist: {
    era: "upheaval",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1976: ElectionContext = {
  year: 1976,
  zeitgeist: {
    era: "upheaval",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1980: ElectionContext = {
  year: 1980,
  zeitgeist: {
    era: "reagan",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1984: ElectionContext = {
  year: 1984,
  zeitgeist: {
    era: "reagan",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1988: ElectionContext = {
  year: 1988,
  zeitgeist: {
    era: "reagan",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1992: ElectionContext = {
  year: 1992,
  zeitgeist: {
    era: "reagan",
...
// ─────────────────────────────────────────────────────────────────────────────
const context1996: ElectionContext = {
  year: 1996,
  zeitgeist: {
    era: "third-way",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2000: ElectionContext = {
  year: 2000,
  zeitgeist: {
    era: "third-way",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2004: ElectionContext = {
  year: 2004,
  zeitgeist: {
    era: "third-way",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2008: ElectionContext = {
  year: 2008,
  zeitgeist: {
    era: "polarization",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2012: ElectionContext = {
  year: 2012,
  zeitgeist: {
    era: "polarization",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2016: ElectionContext = {
  year: 2016,
  zeitgeist: {
    era: "polarization",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2020: ElectionContext = {
  year: 2020,
  zeitgeist: {
    era: "polarization",
...
// ─────────────────────────────────────────────────────────────────────────────
const context2024: ElectionContext = {
  year: 2024,
  zeitgeist: {
    era: "polarization",
...
// Export
// ─────────────────────────────────────────────────────────────────────────────
export const CONTEXTS_1920_2024: ElectionContext[] = [
  context1920,
  context1924,
  context1928,
  context1932,
