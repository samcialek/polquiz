...
<div class="container">
  ...
  <div class="caveats">
    ...
    <p style="margin: 6px 0;"><strong>Plurality match 4/5</strong> (2008 / 2016 / 2020 / 2024 correct; 2012 still wrong — the only cycle where Obama's strong centrist positioning makes the model's D-prediction beat its Abstain prediction). Avg 4-way TV distance 6.85pp. Improved from 2/5 / 9.20pp by the Round-2 calibration sweep on the proper 4-way TV target.</p>
