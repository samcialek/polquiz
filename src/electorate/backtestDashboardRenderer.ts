    ...
    <ul>
      ...
      <li><strong>2016 / 2020 / 2024:</strong> abstention now 36.9–38.6% vs 34.6–42.0% actual (within 5pp on all cycles). Remaining D/R gaps in the 6–11pp range from three additive biases at the vote-prediction layer:
        <ul style="margin-top: 4px;">
          ...
          <li><strong>moralBoundaries — Phase E compatibility pass landed.</strong> 2008 now has real_signal on religious (V215/V216/V217), political_camp (CC307a), ethnic_racial (CC313 affirmative-action 4-pt direction-agnostic), and gender (CC316f SSM-ban direction-agnostic). 2012 has real_signal on gender (CC326 + CC332J direction-agnostic) on top of the existing pid7-derived political_camp and pew_*-derived religious. Each source documented inline as future moralCircleAffinity prior evidence per ADR-007. 2008/2012 nudged +0.5pp / +0.2pp worse on D/R gap from this pass — expected: we added real boundary signal where it had been fallback, but the engine's existing moral-floor-penalty / boundary-distance weights were tuned on archetype centroids and don't yet know how to weight the new CCES signal well. The boundaries are now plumbed through <code>morState</code> and ready for the moralCircleAffinity engine cutover (ADR-007), which is the next consumer that will turn this signal into in-pool D/R gap reduction.</li>
        </ul>
      </li>
