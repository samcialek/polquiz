    ...
    <ul>
      ...
      <li><strong>2016 / 2020 / 2024:</strong> abstention now 36.9–38.6% vs 34.6–42.0% actual (within 5pp on all cycles). Remaining D/R gaps in the 6–11pp range from three additive biases at the vote-prediction layer:
        <ul style="margin-top: 4px;">
          ...
          <li><strong>moralBoundaries module not yet wired for backtest scoring path</strong> — the runner passes morState through to predictVote, but mB salience for ethnic_racial / religious / class is at fallback for 2008/2012 (and partially for 2024). This is the next significant lever and the natural Phase E.</li>
        </ul>
      </li>
